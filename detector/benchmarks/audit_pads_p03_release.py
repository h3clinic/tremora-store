"""Run the PADS-P0.3 audit as two genuinely separate executions.

Two child processes compute the spectral workload and the source-versus-replay
comparison into two empty output roots.  The second is handed the first's run
...
from motionbloom.tremora_store.pads.p03.contract import SUCCESS_MARKER
...
MODULE = "motionbloom.tremora_store.pads.p03.audit"
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    (args.output_root / "pads_p03_release_summary.json").write_bytes(
